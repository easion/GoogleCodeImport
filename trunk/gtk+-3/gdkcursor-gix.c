...
static const struct { 
  ...
  { "arrow", GI_CURSOR_ARROW, 2, 16, 16, 14, 1, 
  ...
  { "bottom_left_corner", GI_CURSOR_SIZENESW, 12, 16, 16, 1, 14, 
  ...
  { "bottom_right_corner", GI_CURSOR_SIZENWSE, 14, 16, 16, 14, 14, 
  ...
  { "bottom_side", GI_CURSOR_SIZENS, 16, 15, 16, 7, 14, 
  ...
  { "center_ptr", GI_CURSOR_UPARROW, 22, 12, 16, 5, 1, 
  ...
  { "clock", GI_CURSOR_APPSTARTING, 26, 15, 16, 6, 3, 
  ...
  { "cross", GI_CURSOR_CROSS, 30, 16, 15, 7, 7, 
  ...
  { "crosshair", GI_CURSOR_CROSS, 34, 16, 15, 7, 7, 
  ...
  { "dotbox", NULL, 40, 14, 14, 7, 6, 
    ...
    "\125" }, 
  { "double_arrow", GI_CURSOR_SIZENS, 42, 12, 16, 6, 8, 
  ...
  { "fleur", GI_CURSOR_SIZEALL, 52, 16, 16, 8, 8, 
  ...
  { "hand1", GI_CURSOR_HAND, 58, 13, 16, 12, 0, 
    ...
    "\000\151\000\000" }, 
  { "hand2", GI_CURSOR_HAND, 60, 16, 16, 0, 1, 
  ...
  { "left_ptr", GI_CURSOR_ARROW, 68, 10, 16, 1, 1, 
  ...
  { "left_side", GI_CURSOR_SIZEWE, 70, 16, 15, 1, 7, 
  ...
  { "pencil", NULL, 86, 13, 16, 11, 15, 
    ...
    "\244\000\000\031" }, 
  { "pirate", GI_CURSOR_NO, 88, 16, 16, 7, 12, 
  ...
  { "plus", NULL, 90, 12, 12, 5, 6, 
    ...
    "\000\000\125\000" }, 
  { "question_arrow", GI_CURSOR_HELP, 92, 11, 16, 5, 8, 
  ...
  { "right_side", GI_CURSOR_SIZEWE, 96, 16, 15, 14, 7, 
  ...
  { "sizing", GI_CURSOR_SIZENWSE, 120, 16, 16, 8, 8, 
  ...
  { "tcross", GI_CURSOR_CROSS, 130, 15, 15, 7, 7, 
    "\000\005\100\000\000\031\000\000\000\144\000\000\001\220\000\000"
  ...
  { "top_left_corner", GI_CURSOR_SIZENWSE, 134, 16, 16, 1, 1, 
  ...
  { "top_right_corner", GI_CURSOR_SIZENESW, 136, 16, 16, 14, 1, 
  ...
  { "top_side", GI_CURSOR_SIZENS, 138, 15, 16, 7, 1, 
  ...
  { "ur_angle", NULL, 148, 12, 12, 10, 1, 
    ...
    "\151\000\000\125" }, 
  { "watch", GI_CURSOR_WAIT, 150, 16, 16, 15, 9, 
  ...
  { "xterm", GI_CURSOR_IBEAM, 152, 9, 16, 4, 8, 
...
_gdk_cursor_type_to_gix ( GdkCursorType  cursor_type)
{
  ...
  switch (cursor_type)
	...
	case GDK_CURSOR_IS_PIXMAP:
		unimplemented;
    default:
		g_warning("unimplemented cursor_type %d\n", cursor_type);
      return -1;
    }
