...
#define GDK_VISUAL_XVISUAL(vis)       (((GdkVisualPrivate*) vis)->si)
//#define GDK_FONT_XDISPLAY(font)       (((GdkFontPrivate*) font)->xdisplay)
#define GDK_FONT_IFONT(font)          (((GdkFontPrivate*) font)->xfont)
...
GdkColormap* gdkx_colormap_get (gi_color_t xcolormap);
