...
class QGixPaintEnginePrivate;

class QGixPaintEngine : public QRasterPaintEngine
{
    Q_DECLARE_PRIVATE(QGixPaintEngine)
public:
    QGixPaintEngine(QPaintDevice *device);
    virtual ~QGixPaintEngine();
