...
struct _GdkInputVTable {
  ...
  void (*configure_event) (void *xevent, GdkWindow *window);
  void (*enter_event) (void *xevent, GdkWindow *window);
  gint (*other_event) (GdkEvent *event, void  *xevent, GdkWindow *window);
  /* Handle an unidentified event. Returns TRUE if handled, FALSE
     otherwise */
  gint (*window_none_event) (GdkEvent *event, void  *xevent);
