...
gint              gdk_screen;
gi_screen_info_t	  gdk_screen_info;
gi_window_id_t	  gdk_root_window;
gi_window_id_t	  gdk_leader_window;
GdkWindowPrivate  gdk_root_parent = { { NULL, }, NULL, };
gi_window_id_t	  gdk_wm_delete_window; //Atom
gi_window_id_t	  gdk_wm_take_focus;	//Atom
gi_window_id_t	  gdk_wm_protocols;	//Atom
gi_window_id_t	  gdk_wm_window_protocols[2];	//Atom
gi_window_id_t	  gdk_selection_property;	//Atom
