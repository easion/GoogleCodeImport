//
// "$Id: Window_fullscreen.cxx 6232 2008-09-14 04:11:27Z spitzak $"
//
...
#elif defined(USE_GI)
	gi_fullscreen_window(xid(window),fullscreen);
	//TRACE_HERE;
#elif defined(_WIN32)
...
#elif USE_GI
  gi_wm_maximize_window(fltk::xid(this));
...
//
// End of "$Id: Window_fullscreen.cxx 6232 2008-09-14 04:11:27Z spitzak $".
//
