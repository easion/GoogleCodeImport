...
public:
    ...
    static bool gix_apply_settings();    
#endif
...
#if defined(Q_WS_GIX)
    static void gix_initialize_style();
#endif
...
#if defined(Q_WS_MAC) || defined(Q_WS_X11) || defined(Q_WS_GIX)
...
#elif defined(Q_WS_GIX)
  extern void qt_gix_enforce_cursor(QWidget *, bool);
  extern void qt_gix_enforce_cursor(QWidget *);
