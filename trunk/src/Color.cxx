//
// "$Id: Color.cxx 5469 2006-09-19 20:03:07Z spitzak $"
//
...
fltk::Color fltk::parsecolor(const char* name, unsigned length) {
  ...
  if (length < 128) {
    ...
    gi_color_t x;
   // open_display();
    if (gi_parse_color(  buf, &x))
      return ccolor(GI_RED(x), GI_GREEN(x), GI_BLUE(x)>>8);
  }
#endif
...
//
// End of "$Id: Color.cxx 5469 2006-09-19 20:03:07Z spitzak $".
//
