//
// "$Id: Fl_Gl_Choice.cxx 8396 2011-02-07 13:51:17Z manolo $"
//
...
#    endif
  ...
  fl_open_display();
  gi_screen_info_t *visp = glXChooseVisual(fl_display, fl_screen, (int *)blist);
  if (!visp) {
#    if defined(GLX_VERSION_1_1) && defined(GLX_SGIS_multisample)
...
# error platform unsupported
  ...
  if (/*MaxCmapsOfScreen(ScreenOfDisplay(fl_display,fl_screen))==1 && */
    ...
    g->colormap = XCreateColormap(fl_display, GI_DESKTOP_WINDOW_ID,
...
GLContext fl_create_gl_context(gi_screen_info_t* vis) {
...
//
// End of "$Id: Fl_Gl_Choice.cxx 8396 2011-02-07 13:51:17Z manolo $".
//
