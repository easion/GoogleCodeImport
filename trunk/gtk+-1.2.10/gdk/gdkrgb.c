...
{
        g_message("Enter gdk_rgb_cmap_fail()");
	return 0;
}
...
{
        g_message("Enter gdk_rgb_make_colorcube");
}
...
{
        g_message("gdk_rgb_make_colorcube_d");
}
...
{
  g_message("gdk_rgb_try_colormap");
  return FALSE;
}
...
{
  g_message("gdk_rgb_do_colormaps");
  return FALSE;
}
...
{
	g_message("Enter gdk_rgb_score_visual()");
	return 0;
}
...
{
	g_message("Enter gdk_rgb_choose_visual()");
}

static void
gdk_rgb_set_gray_cmap (GdkColormap *cmap)
{
        g_message("gdk_rgb_set_gray_cmap");
}
#endif
...
/* convert an rgb value into an Nano-X pixel code */
gulong
...
{
        g_message("HAIRY_CONVERT_8 : gdk_rgb_convert_8");
}
#else
static void
gdk_rgb_convert_8 (GdkImage *image,
...
gdk_rgb_convert_8_d666 (GdkImage *image,
			...
			gint x_align, gint y_align, GdkRgbCmap *cmap)
{
        g_message("gdk_rgb_convert_8_d666");
}
...
gdk_rgb_convert_8_indexed (GdkImage *image,
			   ...
			   gint x_align, gint y_align, GdkRgbCmap *cmap)
{
        g_message("gdk_rgb_convert_8_indexed");
}
#endif //PSEUDO_COLOR
		       ...
		       gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  gint r, g, b;
        ...
        g_message("gdk_rgb_convert_gray8");
  bptr = buf;
  bpl = image->bpl;
			    ...
			    gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  guchar *bptr;
        ...
        g_message("gdk_rgb_convert_gray8_gray");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0;
  for (y = 0; y < height; y++)
		     ...
		     gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  guchar r, g, b;
        ...
        g_message("HAIRY_CONVERT_565 : gdk_rgb_convert_565");
  bptr = buf;
  bpl = image->bpl;
			  ...
			  gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  guchar g;
        ...
        g_message("HAIRY_CONVERT_565 gdk_rgb_convert_565_gray");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0 * 2;
  for (y = 0; y < height; y++)
...
gdk_rgb_convert_565_gray (GdkImage *image,
			  ...
			  gint x_align, gint y_align, GdkRgbCmap *cmap)
{
        g_message("gdk_rgb_convert_565_gray");
}
#endif
			...
			gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  guchar r, g, b;
        ...
        g_message("gdk_rgb_convert_565_br");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0 * 2;
  for (y = 0; y < height; y++)
		     ...
		     gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("HAIRY_CONVERT_565 gdk_rgb_convert_565_d");
  width += x_align;
  height += y_align;
...
gdk_rgb_convert_565_d (GdkImage *image,
                       ...
                       gint x_align, gint y_align, GdkRgbCmap *cmap)
{
        g_message("gdk_rgb_convert_565_d");
}
#endif
			 ...
			 gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  int r, g, b;
        ...
        g_message("HAIRY_CONVERT_888 gdk_rgb_convert_888_lsb");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0 * 3;
  for (y = 0; y < height; y++)
			 ...
			 gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_888_lsb");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0 * 3;
  for (y = 0; y < height; y++)
		      ...
		      gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_0888");
  bptr = buf;
  bpl = image->bpl;
			 ...
			 gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_0888_br");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0 * 4;
  for (y = 0; y < height; y++)
			 ...
			 gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_8880_br");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0 * 4;
  for (y = 0; y < height; y++)
				 ...
				 GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_truecolor_lsb_d");
			       ...
			       GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_truecolor_msb");
  r_right = 8 - image_info->visual->red_prec;
  r_left = image_info->visual->red_shift;
  g_right = 8 - image_info->visual->green_prec;
  g_left = image_info->visual->green_shift;
				 ...
				 GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_truecolor_msb_d");
  r_right = 8 - image_info->visual->red_prec;
  r_left = image_info->visual->red_shift;
  r_prec = image_info->visual->red_prec;
  g_right = 8 - image_info->visual->green_prec;
...
int FindNearestColor(guchar r, guchar g, guchar b)
{
        MWPALENTRY *    rgb;
        int             R, G, B;
        ...
        for(rgb=pal; diff && rgb < &pal[16]; ++rgb) {
                R = rgb->r - r;
                G = rgb->g - g;
                B = rgb->b - b;
		   ...
		   GdkRgbCmap *cmap)
{
  ...
  for (y = 0; y < height; y++)
      ...
      for (x = 0; x < width; x += 1)
	{
	  ...
	  g = *bp2++;
	  b = *bp2++;
          *obptr = (guchar)gdk_color_find(r,g,b);//FindNearestColor(r,g,b);
	  obptr++;
	}
      bptr += rowstride;
      obuf += bpl;
...
int ALPHA;
static void
gdk_rgb_convert_332 (GdkImage *image,
                   gint x0, gint y0, gint width, gint height,
                   guchar *buf, int rowstride,
                   gint x_align, gint y_align,
                   GdkRgbCmap *cmap)
      ...
      for (x = 0; x < width; x += 1)
        {
          ...
          g = *bp2++;
          b = *bp2++;
          *obptr = (guchar)gi_color_to_pixel(&gdk_screen_info,r,g,b);
          obptr++;
        }
      bptr += rowstride;
      obuf += bpl;
...
#ifdef MINIMIZE_MEM
static void
gdk_rgb_convert_332_self (gint x0, gint y0, gint width, gint height,
                   guchar *buf, int rowstride,
                   gint x_align, gint y_align,
                   GdkRgbCmap *cmap,
                   int alpha)
{
        ...
        g_message("gdk_rgb_convert_332_self");
        obuf = bptr = buf;
  	bpl = (width *GI_RENDER_FORMAT_BPP(gdk_screen_info.format)) >> 3;
  	if(GI_RENDER_FORMAT_BPP(gdk_screen_info.format) < 8) bpl = width;
...
static void
gdk_rgb_convert_444 (GdkImage *image,
                   gint x0, gint y0, gint width, gint height,
                   guchar *buf, int rowstride,
                   gint x_align, gint y_align,
                   GdkRgbCmap *cmap)
      ...
      for (x = 0; x < width; x += 1)
        {
          ...
          g = *bp2++;
          b = *bp2++;
          *(guint16 *)obptr = (guint16)RGB2PIXEL444(r,g,b); 
          obptr+=2;
        }
      bptr += rowstride;
      obuf += bpl;
      ...
      for (x = 0; x < width; x += 1)
        {
          ...
          b = *bp2++;
          *obptr = (r&0xf)<<4;
	  *obptr |= (*obptr & 0xf0 ) | (g & 0xf); 
	  obptr++;
          *obptr = (b&0xf)<<4;
          r = *bp2++;
          g = *bp2++;
          b = *bp2++;
	  *obptr |= (*obptr & 0xf0 ) | (r & 0xf); 
          *obptr = (g&0xf)<<4;
	  *obptr |= (*obptr & 0xf0 ) | (b & 0xf); 
          obptr++;
	  x++;
        }
      bptr += rowstride;
		       ...
		       gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_gray4");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0;
			    ...
			    gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  gint shift;
  guchar pix0, pix1;
  gint max_color = gdk_screen_info.ncolors -1;

  /* todo: this is hardcoded to big-endian. Make endian-agile. */

  g_message("gdk_rgb_convert_gray4_pack");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0 ;
  shift = 9 - image_info->visual->depth;
		       ...
		       gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_gray4_pack_d");
  bptr = buf;
  bpl = image->bpl;
  obuf = ((guchar *)image->mem) + y0 * bpl + x0;
			      ...
			      gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  ...
  g_message("gdk_rgb_convert_gray4_d_pack");
  bptr = buf;
  bpl = image->bpl;
...
gdk_rgb_32_to_stage (guchar *buf, gint rowstride, gint width, gint height)
{
  ...
  g_message("slow :gdk_rgb_32_to_stage");
  pi_start = buf;
...
gdk_rgb_convert_32_generic (GdkImage *image,
			    ...
			    gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  g_message("gdk_rgb_convert_32_generic");
...
gdk_rgb_convert_32_generic_d (GdkImage *image,
			      ...
			      gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  g_message("gdk_rgb_convert_32_generic_d");
  gdk_rgb_32_to_stage (buf, rowstride, width, height);
...
gdk_rgb_gray_to_stage (guchar *buf, gint rowstride, gint width, gint height)
{
  ...
  g_message("slow : gdk_rgb_gray_to_stage");
  pi_start = buf;
  po_start = gdk_rgb_ensure_stage ();
  for (y = 0; y < height; y++)
    {
...
gdk_rgb_convert_gray_generic (GdkImage *image,
			      ...
			      gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  g_message("gdk_rgb_convert_gray_generic");
...
gdk_rgb_convert_gray_generic_d (GdkImage *image,
				...
				gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  g_message("gdk_rgb_convert_gray_generic_d");
  gdk_rgb_gray_to_stage (buf, rowstride, width, height);
...
gdk_rgb_convert_gray_cmap (GdkImage *image,
			   ...
			   gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  g_message("gdk_rgb_convert_gray_cmap");
			  ...
			  GdkRgbCmap *cmap)
{
  ...
  g_message("slow : gdk_rgb_indexed_to_stage");
  pi_start = buf;
  po_start = gdk_rgb_ensure_stage ();
  for (y = 0; y < height; y++)
    {
...
gdk_rgb_convert_indexed_generic (GdkImage *image,
				 ...
				 gint x_align, gint y_align, GdkRgbCmap *cmap)
{
  g_message("gdk_rgb_convert_indexed_generic");
...
gdk_rgb_select_conv (GdkImage *image)
{
  ...
  bpp = GI_RENDER_FORMAT_BPP(gdk_screen_info.format);

  byte_order = image->byte_order;
  if (gdk_rgb_verbose)
    g_print ("Chose visual  image bpp=%d, %s first\n",
  ...
  /* I'm not 100% sure about the 24bpp tests - but testing will show*/
	...
	if (bpp == 8)
	{
      		conv = gdk_rgb_convert_332;
      		conv_d = gdk_rgb_convert_332;
	}
	else if (bpp == 12)
	{
		printf("12bpp conv function\n");
      		conv = gdk_rgb_convert_444;
      		conv_d = gdk_rgb_convert_444;
	}
	else
	{
...
#else
        g_warning("GDK_VISUAL_PSEUDO_COLOR with bpp=8 SHOULD NOT reach!");
#endif
    }
  ...
  else if ((bpp==4 || bpp == 8) && depth <= 8 && depth >= 3) /* for GDK_VISUAL_STATIC_COLOR*/
    {
...
static GdkImage *
gdk_conv_rgb_image_core (GdkDrawable *drawable,
                         GdkGC *gc,
                         gint x,
                         gint y,
                         gint width,
...
#ifdef MINIMIZE_MEM
        gdk_rgb_convert_332_self (0, 0, width, height, buf, rowstride,
                                x + xdith, y + ydith, cmap,alpha);
#else
			 ...
			 gint ydith)
{
  ...
  for (y0 = 0; y0 < height; y0 += IMAGE_HEIGHT)
      ...
      for (x0 = 0; x0 < width; x0 += IMAGE_WIDTH)
	{
	  ...
	  /* Shouldn't set to 0, but draw_image call .
		No src_width/fdst_width. Use a soo big buffer, 
		draw unvalid part, crash */
          memset(image->mem,0,image->width*image->height);
...
gdk_draw_rgb_image (GdkDrawable *drawable,
		    ...
		    gint rowstride)
{
        g_message("Enter gdk_draw_rgb_image");
...
GdkImage *
gdk_conv_rgb_image_dithalign (GdkDrawable *drawable,
                              GdkGC *gc,
                              gint x,
                              gint y,
                              gint width,
			      ...
			      gint alpha)
{
  if (dith == GDK_RGB_DITHER_NONE || (dith == GDK_RGB_DITHER_NORMAL &&
                                      !image_info->dith_default))
    gdk_conv_rgb_image_core (drawable, gc, x, y, width, height,
                             rgb_buf, 3, rowstride, image_info->conv, NULL,
                             xdith, ydith,alpha);
  else
    gdk_conv_rgb_image_core (drawable, gc, x, y, width, height,
