...
public:
  ...
  void dispatchButtonPress(const gi_msg_t&);
  void dispatchEnterNotify(const gi_msg_t&);
  void dispatchLeaveNotify(const gi_msg_t&);
  
private:
  gi_window_id_t _usualPixmap, _hilightedPixmap;
