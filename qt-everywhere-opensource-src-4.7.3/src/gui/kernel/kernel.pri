...
unix:gix {
	HEADERS += kernel/qwidget_gix.h
    
	SOURCES += \
		kernel/qapplication_gix.cpp \
		kernel/qwidget_gix.cpp \
		kernel/qdnd_gix.cpp \
		kernel/qdesktopwidget_gix.cpp \
		kernel/qclipboard_gix.cpp \
		kernel/qcursor_gix.cpp \
		kernel/qkeymapper_gix.cpp \
		kernel/qsound_gix.cpp \
		kernel/qeventdispatcher_gix.cpp
}
