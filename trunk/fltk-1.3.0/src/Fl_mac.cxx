...
// external functions
extern Fl_Window* fl_find(gi_window_id_t);
 ...
 * this is also called from the Carbon gi_window_id_t handler after all windows were closed
 */
...
// fc:  
static void  q_set_window_title(gi_window_id_t xid, const char * name ) {
#if 1
