...
static gint  gdk_colormap_alloc_pseudocolors (GdkColormap *colormap,
                                              ...
                                              gboolean     best_match,
                                              gboolean    *success);
static void  gdk_gix_allocate_color_key (GdkColormap *colormap);
...
IGixPalette *
gdk_gix_colormap_get_palette (GdkColormap *colormap)
{
  GdkColormapPrivateGix *private;
...
gdk_gix_allocate_color_key (GdkColormap *colormap)
{
  ...
  colormap->colors[255].red   = ((gdk_gix_bg_color_key.r << 8)
                                 | gdk_gix_bg_color_key.r);
  colormap->colors[255].green = ((gdk_gix_bg_color_key.g << 8)
                                 | gdk_gix_bg_color_key.g);
  colormap->colors[255].blue  = ((gdk_gix_bg_color_key.b << 8)
                                 | gdk_gix_bg_color_key.b);
