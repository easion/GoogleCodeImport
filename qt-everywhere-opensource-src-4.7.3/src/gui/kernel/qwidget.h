...
class QX11Info;
#endif
#if defined(Q_WS_GIX) && !defined(BUILD_WEBKIT)
...
/*    
//#ifdef Q_WS_GIX // Its all for moc, but moc does not support #ifdef
...
protected:
    ...
    virtual bool pfWinEvent(gi_msg_t *message, long *result);
#endif
#if defined(Q_WS_X11)
