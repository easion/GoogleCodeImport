...
class QGixPixmapData : public QPixmapData, public QGixPaintDevice
{
public:
    QGixPixmapData(QGixScreen *screen, PixelType pixelType);
    ~QGixPixmapData();
    ...
    // Pure virtual in QPixmapData, so re-implement here and delegate to QGixPaintDevice
    virtual int metric(QPaintDevice::PaintDeviceMetric m) const { return QGixPaintDevice::metric(m); }
