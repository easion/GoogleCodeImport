...
#endif // Q_WS_X11
#if defined(Q_WS_QWS) || defined(Q_OS_SYMBIAN) || defined(Q_WS_GIX)
    QByteArray fileName;
    int fileIndex;
#endif // defined(Q_WS_QWS) || defined(Q_OS_SYMBIAN) || defined(Q_WS_GIX)
...
struct QtFontStyle
{
    ...
    ~QtFontStyle() {
        ...
        delete [] setwidthName;
#endif
#if defined(Q_WS_X11) || defined(Q_WS_QWS) || defined(Q_OS_SYMBIAN) || defined(Q_WS_GIX)
        while (count) {
...
#if (defined(Q_WS_QWS) && !defined(QT_NO_FREETYPE)) || defined(Q_WS_WIN)  || defined(Q_OS_SYMBIAN) || defined(Q_WS_GIX) || (defined(Q_WS_MAC) && !defined(QT_MAC_USE_COCOA))
...
#if defined(Q_WS_X11) || defined(Q_WS_WIN) || defined(Q_OS_SYMBIAN) || defined(Q_WS_GIX)
