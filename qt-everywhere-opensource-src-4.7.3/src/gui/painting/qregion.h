...
#if defined(Q_WS_QWS) || defined(Q_WS_X11) || defined(Q_WS_MAC) || defined(Q_WS_WIN) || defined(Q_OS_SYMBIAN) || defined(Q_WS_GIX)
...
public:
    ...
    inline gi_region_ptr_t handle() const { if(!d->rgn) updateX11Region(); return d->rgn; }
