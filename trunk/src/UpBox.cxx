//
// "$Id: UpBox.cxx 6132 2008-05-29 23:09:01Z TobiasFar $"
//
...
void drawFocusRect(const fltk::Rectangle& r1) {
  ...
  line_style(DOT);
  //gi_set_line_attributes( gc, 0, GI_GC_LINE_SOLID, GI_GC_CAP_BUTT, GI_GC_JOIN_MITER);
  gi_set_gc_foreground_pixel( gc, 0xffffffff); 
  gi_draw_rect(gc, r.x(), r.y(), r.w()-1, r.h()-1);  
  gi_set_gc_function( gc, GI_MODE_SET);
  line_style(0);
...
//
// End of "$Id: UpBox.cxx 6132 2008-05-29 23:09:01Z TobiasFar $".
//
