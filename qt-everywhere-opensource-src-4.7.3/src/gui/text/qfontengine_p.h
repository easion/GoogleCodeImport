...
#if !defined(Q_WS_X11) && !defined(Q_WS_WIN) && !defined(Q_WS_MAC) && !defined(Q_OS_SYMBIAN) && !defined(Q_WS_GIX)
...
#if defined(Q_WS_WIN) || defined(Q_WS_X11)|| defined(Q_WS_GIX) || defined(Q_WS_QWS) || defined(Q_OS_SYMBIAN) || defined(Q_WS_GIX)
    struct KernPair {
        uint left_right;
        QFixed adjust;
