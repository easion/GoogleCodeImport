...
void Fl_Window::cursor(Fl_Cursor c, Fl_Color c1, Fl_Color c2) {
  ...
  if (c == FL_CURSOR_DEFAULT) {
    ...
    case FL_CURSOR_N:
    case FL_CURSOR_S:
    case FL_CURSOR_NS:		n = GI_CURSOR_SIZENS; break;
    case FL_CURSOR_NE:
    case FL_CURSOR_SW:
    case FL_CURSOR_NESW:	n = GI_CURSOR_SIZENESW; break;
    case FL_CURSOR_E:
    case FL_CURSOR_W:
    case FL_CURSOR_WE:		n = GI_CURSOR_SIZEWE; break;
    case FL_CURSOR_SE:
    case FL_CURSOR_NW:
...
void Fl_Window::cursor(Fl_Cursor c, Fl_Color fg, Fl_Color bg) {
  ...
  if (!c) {
	...
	Pixmap p = XCreateBitmapFromData(fl_display,
	  GI_DESKTOP_WINDOW_ID, (const char*)(q->bits),
	  CURSORSIZE, CURSORSIZE);
	Pixmap m = XCreateBitmapFromData(fl_display,
	  GI_DESKTOP_WINDOW_ID, (const char*)(q->mask),
	  CURSORSIZE, CURSORSIZE);
