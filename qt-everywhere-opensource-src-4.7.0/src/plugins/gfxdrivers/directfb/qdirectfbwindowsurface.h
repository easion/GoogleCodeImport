...
class QGixWindowSurface : public QWSWindowSurface, public QGixPaintDevice
{
public:
    QGixWindowSurface(PLATFORM_CLIP_FLAGS flipFlags, QGixScreen *scr);
    QGixWindowSurface(PLATFORM_CLIP_FLAGS flipFlags, QGixScreen *scr, QWidget *widget);
    ~QGixWindowSurface();
    ...
    QString key() const { return QLatin1String("gix"); }
    ...
    PLATFORM_SURFACE *gixSurface() const;
#ifdef QT_DIRECTFB_WM
    gi_window_id_t gixWindow() const;
#endif
private:
    void updateIsOpaque();
    void setOpaque(bool opaque);
    void releaseSurface();
    QGixWindowSurface *sibling;
